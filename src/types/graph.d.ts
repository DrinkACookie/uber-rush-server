...
export interface Mutation {
  ...
  PhoneVerificationOnSignIn: PhoneVerificationOnSignInResponse;
...
export interface PhoneVerificationOnSignInMutationArgs {
  phoneNumber: string;
  key: string;
}
...
export interface PhoneVerificationOnSignInResponse {
  ok: boolean;
  error: string | null;
}
